...
if (!nexacro.Init_systembase) {
	...
	nexacro._loadJSModule = function (path, target, handler, bcache, service, async) {
		...
		if (nexacro.Browser == "Runtime" && service.cachelevel == "dynamic") {
			bcache = false;
		}
