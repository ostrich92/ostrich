	...
	if (!nexacro._init_platform_HTML5) {
		...
		if (nexacro.Browser == "IE" && nexacro.BrowserVersion >= 8) {
			nexacro._setPopupframeOption = function (id, child) {
				...
				application._popupparentframe[id]._args = option._args;
				application._popupparentframe[id]._popupopener = option._opener;
			...
			nexacro._setOpenInfo = function (child, name) {
				...
				var arr_args = parent_frame._args;
				child.opener = parent_frame._popupopener;
